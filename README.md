...
## 📝 Modelos discriminaivos y generativos

| 📄 Recurso                                                                                                                                                                                                                                                                                                                                                                                                                               | 📥 Acceso                                                                                                                                                                                                                                                                                       |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Modelos Discriminativos vs. Generativos** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Esta clase aborda la distinción fundamental entre los dos paradigmas principales del Machine Learning supervisado. Se explora cómo los <strong>modelos discriminativos</strong> se centran en encontrar el límite que separa las clases de datos (como un inspector de fronteras), aprendiendo la probabilidad condicional <code>P(y|x)</code>. En contraste, los <strong>modelos generativos</strong> aprenden la distribución subyacente de los propios datos (como un cartógrafo cultural) para poder crear nuevos ejemplos, modelando la probabilidad conjunta <code>P(x,y)</code>. El objetivo es entender esta diferencia clave para saber cuándo aplicar cada enfoque y sentar las bases para temas avanzados como las GANs.</p></details> | [![Ver en GitHub](https://img.shields.io/badge/Ver%20en-GitHub-blue?style=for-the-badge&logo=github)](https://#) [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://#) <br> [![Ver Página Web](https://img.shields.io/badge/Apunte-Interactivo-brightgreen?style=for-the-badge&logo=html5)](https://sgevatschnaider.github.io/IA-Teoria-Practica/recursos/discriminativo-vs-generativo.html) |
