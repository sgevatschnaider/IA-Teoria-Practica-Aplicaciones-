...
| 📄 Recurso                                                                                                                                                                                                                                                                                                                          | 📥 Acceso                                                                                                                                                                                                                                                                                                 |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **[EXTRA] Visualización: Árbol de Decisión** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Una página interactiva que explica visualmente el funcionamiento de los Árboles de Decisión, uno de los modelos clave utilizados en el notebook para la clasificación de pasajeros.</p></details>                                  | [![Ver Página Web](https://img.shields.io/badge/Abrir-Página-brightgreen?style=for-the-badge&logo=html5)](https://sgevatschnaider.github.io/IA-Teoria-Practica/recursos/Arbol%20de%20Decisi%C3%B3n.html) |
