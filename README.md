...
| 📄 Recurso                                                                                                                                                                                                                                                                                                                                                                                            | 📥 Acceso                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Clasificación con Machine Learning (PDF)** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Una presentación introductoria que define la clasificación en Machine Learning. Explora los algoritmos clave como Árboles de Decisión, Random Forest y Gradient Boosting, y guía al usuario a través de un ejemplo práctico de predicción de supervivencia en el Titanic usando Google Sheets y la extensión Simple ML.</p></details> | <a href="https://github.com/sgevatschnaider/IA-Teoria-Practica/blob/main/recursos/Clasificaci%C3%B3n%20con%20Machine%20Learning.pdf" target="_blank" rel="noopener noreferrer"><img src="https://img.shields.io/badge/Ver-PDF-red?style=for-the-badge&logo=adobeacrobatreader" alt="Ver PDF"></a> |
