...
| 📄 Recurso                                                                                                                                                                                                                                                                                                                                                                                          | 🔗 Acceso                                                                                                                                                                                                                                                                                                                                          |
| :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Conceptos Fundamentales de LLM**  <br>  
  <details>  
    <summary><strong>Resumen (haz clic para expandir/colapsar)</strong></summary>  
    Esta clase revela el engranaje interno de los LLMs: desde el pre-entrenamiento sobre corpus masivos hasta la generación de respuestas token a token. Veremos los principios del Transformer, el flujo de un prompt por tokenización, embeddings y auto-atención, así como retos éticos y computacionales.  
  </details> | [![Ver en GitHub](https://img.shields.io/badge/Ver%20en-GitHub-blue?style=for-the-badge&logo=github)](https://github.com/sgevatschnaider/IA-Teoria-Practica/blob/840036867bf4857b46193c63b9a60f4105ccd6a2/notebooks/Clase_II_Conceptos_LLM.ipynb)  
  [![Abrir en Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/sgevatschnaider/IA-Teoria-Practica/blob/840036867bf4857b46193c63b9a60f4105ccd6a2/notebooks/Clase_II_Conceptos_LLM.ipynb) |
