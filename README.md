...
| **Notebooks: Modularización en Python (Teoría y Práctica)** <br><br> <details><summary><strong>Resumen:</strong> <em>(haz clic para expandir/colapsar)</em></summary><p>Este conjunto de dos notebooks aborda el concepto de modularización, una práctica esencial para escribir código Python escalable, organizado y mantenible. Se pasa de la teoría fundamental a la aplicación práctica. <br><br> <h4>Contenido:</h4><ul><li><strong>Parte 1 (Teoría - Modularización):</strong> El primer notebook sienta las bases conceptuales.<ul><li><strong>¿Por qué modularizar?:</strong> Explica los beneficios clave como la reutilización de código, la organización de proyectos, la facilidad de mantenimiento y la colaboración en equipo.</li><li><strong>Mecanismos de Importación:</strong> Detalla las diferentes formas de importar módulos y funciones en Python (<code>import modulo</code>, <code>from modulo import funcion</code>, uso de alias con <code>as</code>).</li><li><strong>Bloque <code>if __name__ == "__main__":</code>:</strong> Explica el propósito de esta construcción fundamental, que permite que un archivo Python funcione tanto como un módulo importable como un script ejecutable.</li></ul></li><li><strong>Parte 2 (Ejemplos Prácticos):</strong> El segundo notebook es un taller práctico que demuestra cómo aplicar la teoría.<ul><li><strong>Creación de Módulos:</strong> Utiliza la magia de Jupyter (<code>%%writefile</code>) para crear archivos <code>.py</code> (módulos) directamente desde el notebook.</li><li><strong>Ejemplos Concretos:</strong> Proporciona ejemplos claros (<code>mi_modulo.py</code>, <code>calculadora.py</code>) que muestran cómo definir funciones en un módulo y luego importarlas y utilizarlas en otro script o notebook.</li></ul></li></ul></p></details> | **Parte 1: Teoría** <br> [![Ver en GitHub](https://img.shields.io/badge/Ver%20en-GitHub-blue?style=for-the-badge&logo=github)](https://github.com/sgevatschnaider/IA-Teoria-Practica/blob/86196c62acc353c4988fee283c2ca47e49bed75a/notebooks/Modularizaci%C3%B3n.ipynb) [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/sgevatschnaider/IA-Teoria-Practica/blob/main/notebooks/Modularizaci%C3%B3n.ipynb) <br><br> **Parte 2: Ejemplos Prácticos** <br> [![Ver en GitHub](https://img.shields.io/badge/Ver%20en-GitHub-blue?style=for-the-badge&logo=github)](https://github.com/sgevatschnaider/IA-Teoria-Practica/blob/86196c62acc353c4988fee283c2ca47e49bed75a/notebooks/Ejemplos_modularizaci%C3%B3n.ipynb) [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/sgevatschnaider/IA-Teoria-Practica/blob/main/notebooks/Ejemplos_modularizaci%C3%B3n.ipynb) |
